...
class MarkController extends AbstractController
{
    ...
    {
        return $this->render('mark/index.html.twig', ['marks' => $markRepository->findAll()]);
    }
    ...
    {
        return $this->render('mark/show.html.twig', ['mark' => $mark]);
    }
    ...
    public function edit(Request $request, Mark $mark): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('mark_index', ['id' => $mark->getId()]);
        }
